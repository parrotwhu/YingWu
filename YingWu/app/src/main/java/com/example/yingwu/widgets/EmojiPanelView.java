package com.example.yingwu.widgets;
...
import com.example.yingwu.MainActivity;
...
import com.example.yingwu.beans.emoji.EmojiPanelBean;
import com.example.yingwu.interfaces.OnKeyBoardStateListener;
import com.example.yingwu.utils.TextLinkifyUtils;
...
//        });
    ...
    private void asyncInitEmojiPanelData(List<EmojiDataSource> emojiDataSources) {
        Disposable subscribe = Single.create((SingleOnSubscribe<List<EmojiPanelBean>>) emitter ->
    ...
    public final class EmojiPanelPagerAdapter extends PagerAdapter {
        ...
        EmojiPanelPagerAdapter(List<EmojiPanelBean> emojiPanelBeans) {
    ...
    public final class EmojiPanelItemRecyclerAdapter extends RecyclerView.Adapter<EmojiPanelItemViewHolder> {
        ...
        EmojiPanelItemRecyclerAdapter(Context context, List<EmojiBean> emojiBeans) {
    ...
    private final class EmojiPanelItemViewHolder extends RecyclerView.ViewHolder {
        ...
        EmojiPanelItemViewHolder(View itemView) {
            super(itemView);
